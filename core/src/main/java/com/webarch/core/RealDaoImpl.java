...
import com.webarch.common.shiro.DrRealm;
import com.webarch.common.shiro.RealmDao;
...
public class RealDaoImpl implements RealmDao{
    ...
    public Map<String, Collection<String>> getUserRolesAndPerms(Object uniqueIdentity) {
        ...
        permsAndRoles.put(DrRealm.getRoles_in_map_key(),list);
        permsAndRoles.put(DrRealm.getPerms_in_map_key(),permList);
